...
import '../core/bar_footer.dart';
import '../core/bar_header.dart';
import '../core/bar_item.dart';
import '../core/bar_toggler.dart';
...
class _SideNavigationBarState extends State<SideNavigationBar> {
  /// The minimum and maximum width of the bar. Used for animation
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              ...
              // Navigation content
              Expanded(
                child: Scrollbar(child: ListView(children: _generateItems())),
              ),
  ...
  Border? _evaluateMainDivider() {
    ...
    return Border(
      right: BorderSide(
        ...
        color:
            _theme.dividerTheme.mainDividerColor ??
